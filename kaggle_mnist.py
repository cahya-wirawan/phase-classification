...
def custom_kaggle_mnist():
    ...
    dataset = { "train_x": mnist_train_images, "train_y": mnist_train_labels,
                "valid_x": mnist_valid_images, "valid_y": mnist_valid_labels,
                "test_x": mnist_test_images, "test_y": mnist_test_labels,}
